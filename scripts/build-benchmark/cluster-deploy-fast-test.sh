...
for scenario in "${SCENARIOS[@]}"; do
  ...
  case "${scenario}" in
    ...
    helm-auto)
      run_auto_scenario \
        "helm-auto" \
        "deploy/helm/clustershell/values.yaml" \
