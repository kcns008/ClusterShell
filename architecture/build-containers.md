...
| `crates/clustershell-server/*`, `deploy/docker/Dockerfile.images` | Gateway |
| `crates/clustershell-sandbox/*`, `crates/clustershell-policy/*` | Supervisor |
| `deploy/helm/clustershell/*` | Helm upgrade |
