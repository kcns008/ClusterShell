...
pub const SERVER_TLS_SECRET_NAME: &str = "clustershell-server-tls";
/// K8s secret holding the CA certificate used to verify client certificates.
pub const SERVER_CLIENT_CA_SECRET_NAME: &str = "clustershell-server-client-ca";
/// K8s secret holding the client TLS certificate, key, and CA cert (shared by CLI and sandboxes).
pub const CLIENT_TLS_SECRET_NAME: &str = "clustershell-client-tls";

pub fn container_name(name: &str) -> String {
    format!("clustershell-cluster-{name}")
}
