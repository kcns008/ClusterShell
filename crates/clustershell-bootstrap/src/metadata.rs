...
use clustershell_core::paths::ensure_parent_dir_restricted;
...
///
/// Scans `$XDG_CONFIG_HOME/clustershell/gateways/` for subdirectories containing
...
mod tests {
    ...
    fn metadata_roundtrip() {
        let meta = GatewayMetadata {
            ...
            is_remote: true,
            gateway_port: 8080,
            remote_host: Some("user@clustershell-dev".to_string()),
