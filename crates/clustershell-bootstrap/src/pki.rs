...
const DEFAULT_SERVER_SANS: &[&str] = &[
    "clustershell",
    "clustershell.clustershell.svc",
    "clustershell.clustershell.svc.cluster.local",
    "localhost",
...
pub fn generate_pki(extra_sans: &[String]) -> Result<PkiBundle> {
    ...
    ca_params
        .distinguished_name
        .push(DnType::OrganizationName, "clustershell");
    ca_params
        .distinguished_name
        .push(DnType::CommonName, "clustershell-ca");
    ...
    server_params
        .distinguished_name
        .push(DnType::CommonName, "clustershell-server");
    ...
    client_params
        .distinguished_name
        .push(DnType::CommonName, "clustershell-client");
