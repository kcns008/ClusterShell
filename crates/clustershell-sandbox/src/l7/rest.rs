...
mod tests {
    ...
    fn rewrite_header_block_resolves_placeholder_auth_headers() {
        ...
        assert!(!rewritten.contains("clustershell:resolve:env:ANTHROPIC_API_KEY"));
    }
    ...
    /// silently leaks placeholder strings like `clustershell:resolve:env:NVIDIA_API_KEY`
    ...
    async fn relay_request_with_resolver_rewrites_credential_placeholders() {
        ...
        assert!(
            !forwarded.contains("clustershell:resolve:env:"),
    ...
    async fn relay_request_without_resolver_leaks_placeholders() {
        ...
        assert!(
            forwarded.contains("clustershell:resolve:env:NVIDIA_API_KEY"),
