...
/// ```text
/// ...,;clustershell:bypass:<ns-id>:IN= OUT=veth-s-... SRC=10.200.0.2 DST=93.184.216.34
...
pub fn spawn(
    ...
    let namespace_prefix = format!("clustershell:bypass:{namespace_name}:");
    debug!(
...
mod tests {
    ...
    fn parse_kmsg_line_tcp_bypass() {
        let line = "6,1234,5678,-;clustershell:bypass:sandbox-abcd1234:IN= OUT=veth-s-abcd1234 \
        ...
        let event = parse_kmsg_line(line, "clustershell:bypass:sandbox-abcd1234:").unwrap();
    ...
    fn parse_kmsg_line_udp_dns_bypass() {
        let line = "6,5678,9012,-;clustershell:bypass:sandbox-abcd1234:IN= OUT=veth-s-abcd1234 \
    ...
    fn parse_kmsg_line_wrong_namespace_returns_none() {
        let line = "6,1234,5678,-;clustershell:bypass:sandbox-other:IN= OUT=veth \
                    SRC=10.200.0.2 DST=1.2.3.4 PROTO=TCP SPT=1111 DPT=80";

        let result = parse_kmsg_line(line, "clustershell:bypass:sandbox-abcd1234:");
    ...
    fn parse_kmsg_line_missing_dst_returns_none() {
        let line = "6,1234,5678,-;clustershell:bypass:sandbox-abcd1234:IN= OUT=veth \
