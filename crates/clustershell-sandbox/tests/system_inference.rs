...
use clustershell_router::config::{AuthHeader, ResolvedRoute};
use clustershell_sandbox::proxy::InferenceContext;
...
async fn system_inference_routes_to_mock_backend() {
    ...
    let patterns = clustershell_sandbox::l7::inference::default_patterns();
