...
pub type CreateFormData = (
    ...
    String,
    Vec<String>,
    Vec<clustershell_core::forward::ForwardSpec>,
);
...
pub struct App {
    ...
    pub endpoint: String,
    pub client: ClusterShellClient<Channel>,
    ...
    pub sandbox_policy: Option<clustershell_core::proto::SandboxPolicy>,
    ...
    pub pending_forward_ports: Vec<clustershell_core::forward::ForwardSpec>,
    ...
    pub draft_chunks: Vec<clustershell_core::proto::PolicyChunk>,
    ...
    pub approve_all_confirm_chunks: Vec<clustershell_core::proto::PolicyChunk>,
}
...
impl App {
    ...
    pub fn apply_global_settings(
        &mut self,
        settings: HashMap<String, clustershell_core::proto::SettingValue>,
        revision: u64,
    ) {
    ...
    pub fn apply_sandbox_settings(
        &mut self,
        settings: HashMap<String, clustershell_core::proto::EffectiveSetting>,
    ) {
    ...
    pub fn create_form_data(&self) -> Option<CreateFormData> {
        ...
        let providers: Vec<String> = form
            ...
            .map(|p| p.name.clone())
            .collect();
        let ports: Vec<clustershell_core::forward::ForwardSpec> = form
            .ports
            .split(',')
            .filter_map(|s| {
                let s = s.trim();
                ...
                clustershell_core::forward::ForwardSpec::parse(s).ok()
            })
            .collect();
        Some((
            form.name.clone(),
    ...
    fn open_create_provider_form(&mut self) {
        let known = clustershell_providers::ProviderRegistry::new().known_types();
        ...
        match form.phase {
            CreateProviderPhase::SelectType => match key.code {
                ...
                KeyCode::Enter => {
                    ...
                    let registry = clustershell_providers::ProviderRegistry::new();
