...
impl SandboxContext {
    ...
    pub fn metadata(&self, profiles: &[&str]) -> Metadata {
        Metadata {
            ...
            product: Product::clustershell_sandbox(&self.product_version),
...
pub(crate) fn test_sandbox_context() -> SandboxContext {
    SandboxContext {
        ...
        container_image: "ghcr.io/clustershell/sandbox:latest".to_string(),
...
mod tests {
    ...
    fn test_sandbox_context_metadata() {
        ...
        assert_eq!(meta.product.name, "ClusterShell Sandbox Supervisor");
