...
impl Product {
    /// Create the standard `ClusterShell` Sandbox Supervisor product.
    #[must_use]
    pub fn clustershell_sandbox(version: &str) -> Self {
        Self {
            name: "ClusterShell Sandbox Supervisor".to_string(),
...
mod tests {
    ...
    assert_eq!(json["product"]["name"], "ClusterShell Sandbox Supervisor");
    assert_eq!(json["product"]["vendor_name"], "ClusterShell");
