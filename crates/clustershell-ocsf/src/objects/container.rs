...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct Image {
    /// Image name (e.g., "ghcr.io/clustershell/sandbox:latest").
    pub name: String,
}
...
mod tests {
    ...
    fn test_container_serialization() {
        let container = Container {
            ...
            image: Some(Image {
                name: "ghcr.io/clustershell/sandbox:latest".to_string(),
            }),
        };
        ...
        assert_eq!(json["image"]["name"], "ghcr.io/clustershell/sandbox:latest");
    }
