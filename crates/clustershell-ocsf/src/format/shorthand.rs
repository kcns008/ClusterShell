...
impl OcsfEvent {
    /// Produce the single-line shorthand for `clustershell.log` and gRPC log push.
    ///
...
mod tests {
    ...
    fn test_metadata() -> Metadata {
        Metadata {
            ...
            product: Product::clustershell_sandbox("0.1.0"),
    ...
    fn test_lifecycle_shorthand() {
        ...
        let event = OcsfEvent::ApplicationLifecycle(ApplicationLifecycleEvent {
            base: b,
            app: Product {
                name: "clustershell-sandbox".to_string(),
                vendor_name: "ClusterShell".to_string(),
        ...
        assert_eq!(
            shorthand,
            "14:00:00.000 I LIFECYCLE:START clustershell-sandbox success"
        );
    }
    ...
    fn test_base_event_shorthand() {
        ...
        b.add_unmapped("ns", serde_json::json!("clustershell-sandbox-abc123"));
        ...
        assert_eq!(
            shorthand,
            "14:00:00.000 I EVENT Network namespace created [ns:clustershell-sandbox-abc123]"
        );
    }
}
