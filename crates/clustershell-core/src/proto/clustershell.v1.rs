...
pub struct WatchSandboxRequest {
    ...
    /// Stream clustershell-server process logs correlated to this sandbox.
    #[prost(bool, tag = "3")]
...
/// ClusterShell server process log line correlated to a sandbox.
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod open_shell_client {
    ...
    /// ClusterShell service provides agent execution and management capabilities.
    #[derive(Debug, Clone)]
    pub struct ClusterShellClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl ClusterShellClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> ClusterShellClient<InterceptedService<T, F>>
        where
        ...
        {
            ClusterShellClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        pub async fn health(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/clustershell.v1.ClusterShell/Health",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clustershell.v1.ClusterShell", "Health"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/clustershell.v1.ClusterShell/CreateSandbox",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clustershell.v1.ClusterShell", "CreateSandbox"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/clustershell.v1.ClusterShell/GetSandbox",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clustershell.v1.ClusterShell", "GetSandbox"));
            self.inner.unary(req, path, codec).await
        }
        /// List sandboxes.
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/clustershell.v1.ClusterShell/ListSandboxes",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clustershell.v1.ClusterShell", "ListSandboxes"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/clustershell.v1.ClusterShell/DeleteSandbox",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clustershell.v1.ClusterShell", "DeleteSandbox"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/clustershell.v1.ClusterShell/CreateSshSession",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clustershell.v1.ClusterShell", "CreateSshSession"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/clustershell.v1.ClusterShell/RevokeSshSession",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clustershell.v1.ClusterShell", "RevokeSshSession"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/clustershell.v1.ClusterShell/GetSandboxPolicy",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clustershell.v1.ClusterShell", "GetSandboxPolicy"));
            self.inner.unary(req, path, codec).await
        }
        ...
        /// - ClusterShell server process logs correlated by sandbox_id
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/clustershell.v1.ClusterShell/WatchSandbox",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clustershell.v1.ClusterShell", "WatchSandbox"));
...
pub mod open_shell_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with ClusterShellServer.
    #[async_trait]
    pub trait ClusterShell: std::marker::Send + std::marker::Sync + 'static {
        /// Check the health of the service.
        async fn health(
            &self,
    ...
    /// ClusterShell service provides agent execution and management capabilities.
    #[derive(Debug)]
    pub struct ClusterShellServer<T> {
        inner: Arc<T>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ClusterShellServer<T>
    where
        T: ClusterShell,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/clustershell.v1.ClusterShell/Health" => {
                    ...
                    struct HealthSvc<T: ClusterShell>(pub Arc<T>);
                    impl<T: ClusterShell> tonic::server::UnaryService<super::HealthRequest>
                    for HealthSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ClusterShell>::health(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/clustershell.v1.ClusterShell/CreateSandbox" => {
                    #[allow(non_camel_case_types)]
                    struct CreateSandboxSvc<T: ClusterShell>(pub Arc<T>);
                    impl<
                        T: ClusterShell,
                    ...
                    for CreateSandboxSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClusterShell>::create_sandbox(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/clustershell.v1.ClusterShell/GetSandbox" => {
                    #[allow(non_camel_case_types)]
                    struct GetSandboxSvc<T: ClusterShell>(pub Arc<T>);
                    impl<
                        T: ClusterShell,
                    ...
                    for GetSandboxSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClusterShell>::get_sandbox(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/clustershell.v1.ClusterShell/ListSandboxes" => {
                    #[allow(non_camel_case_types)]
                    struct ListSandboxesSvc<T: ClusterShell>(pub Arc<T>);
                    impl<
                        T: ClusterShell,
                    ...
                    for ListSandboxesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClusterShell>::list_sandboxes(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/clustershell.v1.ClusterShell/DeleteSandbox" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteSandboxSvc<T: ClusterShell>(pub Arc<T>);
                    impl<
                        T: ClusterShell,
                    ...
                    for DeleteSandboxSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClusterShell>::delete_sandbox(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/clustershell.v1.ClusterShell/CreateSshSession" => {
                    #[allow(non_camel_case_types)]
                    struct CreateSshSessionSvc<T: ClusterShell>(pub Arc<T>);
                    impl<
                        T: ClusterShell,
                    ...
                    for CreateSshSessionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClusterShell>::create_ssh_session(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/clustershell.v1.ClusterShell/RevokeSshSession" => {
                    #[allow(non_camel_case_types)]
                    struct RevokeSshSessionSvc<T: ClusterShell>(pub Arc<T>);
                    impl<
                        T: ClusterShell,
                    ...
                    for RevokeSshSessionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClusterShell>::revoke_ssh_session(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/clustershell.v1.ClusterShell/GetSandboxPolicy" => {
                    #[allow(non_camel_case_types)]
                    struct GetSandboxPolicySvc<T: ClusterShell>(pub Arc<T>);
                    impl<
                        T: ClusterShell,
                    ...
                    > for GetSandboxPolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClusterShell>::get_sandbox_policy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/clustershell.v1.ClusterShell/WatchSandbox" => {
                    #[allow(non_camel_case_types)]
                    struct WatchSandboxSvc<T: ClusterShell>(pub Arc<T>);
                    impl<
                        T: ClusterShell,
                    ...
                    for WatchSandboxSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClusterShell>::watch_sandbox(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for ClusterShellServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "clustershell.v1.ClusterShell";
    impl<T> tonic::server::NamedService for ClusterShellServer<T> {
