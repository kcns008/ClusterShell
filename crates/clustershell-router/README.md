...
`clustershell-router` is the inference routing and upstream execution engine used by `clustershell-server`.
...
These are owned by `clustershell-server`.

## Integration contract with clustershell-server
