...
fn render_connect_page(
    ...
    let version = clustershell_core::VERSION;
...
<head>
    ...
    <title>ClusterShell — Connect to Gateway</title>
    <style>
...
<body>
    <div class="card">
        ...
        <div class="hint">
            This will authorize the ClusterShell CLI to connect to this gateway.
        </div>
    ...
    <script>
        ...
        function connect() {{
            ...
            .catch(function(err) {{
                ...
                btn.textContent = 'Connect to Gateway';
                status.className = 'status status-err';
                status.textContent = 'Could not reach the CLI. Is clustershell still running?';
            }});
        }}
    </script>
</body>
...
mod tests {
    ...
    fn render_connect_page_contains_token_and_code() {
        ...
        assert!(html.contains("ClusterShell"));
