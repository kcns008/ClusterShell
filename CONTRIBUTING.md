...
1. Open a [Vouch Request](https://github.com/NVIDIA/ClusterShell/discussions/new?category=vouch-request) discussion.
...
Issues labeled [`good-first-issue`](https://github.com/NVIDIA/ClusterShell/issues?q=is%3Aissue+is%3Aopen+label%3Agood-first-issue) are scoped, well-documented, and friendly to new contributors. Start there. If you need guidance, comment on the issue.
