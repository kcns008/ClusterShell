...
```bash
docker exec clustershell-cluster-clustershell \
...
```bash
docker exec clustershell-cluster-clustershell kubectl get pod private-api -o wide
```
...
```bash
clustershell sandbox create -- bash -c \
...
```bash
docker exec clustershell-cluster-clustershell kubectl delete pod private-api
```
