...
A capture-the-flag challenge that exercises ClusterShell's policy recommendation
...
GATES: list[dict] = [
    ...
    },
    {
        ...
        "method": "GET",
        "headers": {"Accept": "application/json", "User-Agent": "clustershell-ctf"},
        "body": None,
    ...
    # -- Gate 7: HTTPS to internal IP (allowed_ips SSRF override) -------------
    {
        ...
        "method": "GET",
        "headers": {"User-Agent": "clustershell-ctf"},
        "body": None,
...
def run_ctf() -> int:
    ...
    log(
        "INFO",
        "Tip: open the TUI now if you haven't  ->  clustershell term",
    )
    print()
