...
from clustershell import InferenceRouteClient, Sandbox, SandboxClient
from clustershell._proto import datamodel_pb2
...
def cluster_name() -> str | None:
    return os.environ.get("CLUSTERSHELL_GATEWAY")
...
def ensure_sandbox_persistence_ready(sandbox_client: SandboxClient) -> None:
    ...
    pytest.fail(
        "clustershell-server persistence is not initialized (missing sqlite objects table); "
