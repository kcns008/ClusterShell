---
title:
  page: NVIDIA ClusterShell Developer Guide
  nav: Get Started
  card: NVIDIA ClusterShell
...
<div class="nc-term">
  ...
  <div class="nc-term-body">
    <div><span class="nc-ps">$ </span>uv tool install -U clustershell</div>
    <div><span class="nc-ps">$ </span>clustershell sandbox create <span class="nc-swap"><span>-- <span class="nc-hl">claude</span></span><span>--from <span class="nc-hl">openclaw</span></span><span>-- <span class="nc-hl">opencode</span></span><span>-- <span class="nc-hl">codex</span></span></span><span class="nc-cursor"></span></div>
  </div>
</div>
```
...
:::{grid-item-card} About ClusterShell
:link: about/overview
:link-type: doc

Learn about ClusterShell and its capabilities.
...
```{toctree}
:caption: About NVIDIA ClusterShell
:hidden:
