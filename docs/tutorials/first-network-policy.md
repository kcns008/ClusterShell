...
:::{tip}
To run every step of this tutorial, you can also use the automated demo script at the [examples/sandbox-policy-quickstart](https://github.com/NVIDIA/ClusterShell/blob/main/examples/sandbox-policy-quickstart) directory in the NVIDIA ClusterShell repository. It runs the full walkthrough in under a minute but without any user interaction.
