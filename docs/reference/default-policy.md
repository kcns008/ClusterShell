...
title:
  ...
  nav: "Default Policy"
description: "Breakdown of the built-in default policy applied when you create an ClusterShell sandbox without a custom policy."
keywords: ["clustershell default policy", "sandbox policy", "agent compatibility"]
...
The default policy blocks are defined in the community base image. See the [clustershell-community repository](https://github.com/nvidia/clustershell-community) for the full `dev-sandbox-policy.yaml` source.
