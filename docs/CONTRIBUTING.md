# Contributing to NVIDIA ClusterShell Documentation

This guide covers how to write, edit, and review documentation for NVIDIA ClusterShell. If you change code that affects user-facing behavior, update the relevant docs in the same PR.
...
| Superlatives | "ClusterShell provides a powerful, robust, seamless experience." | Say what it does, not how great it is. |
...
| ClusterShell | Open Shell, openShell, Openshell, clustershell |
| mTLS | MTLS, mtls |
| YAML | yaml, Yaml |
